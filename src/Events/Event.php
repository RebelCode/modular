 ...
 *
 * This is a temporary class and should not be depended on explicitly. This implementation exists in this package
 * only because there is no other standalone implementation at the time of writing. Use the {@link EventFactory} in
 * this package as an abstraction or depend on a {@link \Dhii\Event\EventFactoryInterface} for more added abstraction.
 *
 * @since [*next-version*]
 */
